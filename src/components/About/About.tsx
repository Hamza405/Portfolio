...
const About: FC<{ skills: Skill[] }> = ({ skills }) => {
  return (
    <div
      id="about"
      className="flex w-full md:h-screen flex-wrap justify-between items-center p-4 mx-auto my-12 sm:my-14"
    >
      <div className="py-4 max-w-[85%] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p>
            ...
            aliquid voluptas, similique aliquam accusamus, ut quidem soluta
            animi tempore libero error porro earum sequi provident sunt. Ipsam
            obcaecati nisi aut!
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa,
